function [satellite_positions_visible,satellite_visible,true_range_visible,elevation,canyon_sats_index] = filter_satellites_visible(satellite_positions,satellite,true_range,mask_angle,position_estimate,flag)
